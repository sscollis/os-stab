...
C
C     Modified for complex problems (SSC 1992)
C
C***********************************************************************
...
C***********************************************************************
C
C     What follows is the original ODEINT from Numerical Recipes.
C     I have renamed it ODEINTR to denote that it works for real
C     valued equations.
C
C***********************************************************************
C23456789012345678901234567890123456789012345678901234567890123456789012
...
C     by the adaptive routines, ODEINT and ODEINTR
C
c***********************************************************************
      external    FUNC
      integer     neq
